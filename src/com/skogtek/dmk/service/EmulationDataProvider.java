...
public class EmulationDataProvider extends ContentProvider {

    private static final String TAG = "EmulationDataProvider";

    private static final String DATABASE_NAME = "emu.db";
    private static final int DATABASE_VERSION = 2;
    private static final String TABLE_NAME = "zpacket";
