...
public class LoggerService extends Service
{
    ...
    public void onCreate() 
    {
    	...
    	Log.e(LoggerConstants.LOG_ID, "LoggerServiceThread.onCreate");
    ...
    public int startLogging()
    {
    	...
    	new Thread(new Runnable()
    	{
    		public void run()
    		{
    			...
    			localAddress =  new InetSocketAddress(LoggerPrefs.localPort);
    			remoteAddress =  new InetSocketAddress(LoggerPrefs.remoteIP, LoggerPrefs.remotePort);
    ...
    {
    	public void setLoggerController(LoggerController lc)
    	{
    		loggerController = lc;
    	}
    ...
    private void showNotification() 
    {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, LoggerController.class), 0);
    ...
    private void connectWifi()
    {
        ...
        config.SSID = LoggerConstants.SSID;
		...
		public void onReceive(Context context, Intent intent) 
		{
			...
			else if(action.equals(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION))
			{
				...
				for(int i=0; i<results.size(); i++)
				{
					...
					if(results.get(i).SSID.equals(LoggerConstants.SSID))
					{
